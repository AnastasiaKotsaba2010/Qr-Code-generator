...
SECRET_KEY = 'django-insecure-5vif!c!9t)7dary$6m&r8bs4j$n&4)f!p8(6vhxh#yh3$7y-@a'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR / 'my_QrCode' / 'templates',  
            BASE_DIR / 'generate' / 'templates',
            BASE_DIR / 'plan_settings' / 'templates',  
